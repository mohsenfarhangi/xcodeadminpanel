...
<div class="d-flex align-items-center flex-shrink-0">
    <div class="me-3 py-3 py-lg-0">
        {!! \App\Http\Core\Adapters\Theme::getSvgIcon('icons/duotune/maps/map007.svg','svg-icon-3') !!}
        <span>
            همه
        </span>
    </div>
    ...
    <div class="me-3 py-3 py-lg-0">
        <!--begin::Search-->
        <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-225px"
            ...
            <form data-kt-search-element="form" class="d-none d-lg-block w-100 mb-5 mb-lg-0 position-relative"
                ...
                <!--end::Hidden input-->
                <!--begin::Icon-->
                {!! \App\Http\Core\Adapters\Theme::getSvgIcon('icons/duotune/maps/map007.svg','svg-icon-2 svg-icon-gray-700 position-absolute top-50 translate-middle-y ms-4') !!}
                <!--end::Icon-->
                <!--begin::Input-->
                <input type="text" class="form-control bg-transparent ps-13 fs-7 h-40px" name="search" value=""
                       placeholder="{{__('cpanel.Location')}}" data-kt-search-element="input"/>
                <!--end::Input-->
                <!--begin::Spinner-->
                ...
                <div data-kt-search-element="wrapper">
                    ...
                    <div class="" data-kt-search-element="main">
                        ...
                        <div class="d-flex flex-stack fw-semibold mb-4">
                            <!--begin::Label-->
                            <span class="text-muted fs-6 me-2">{{__('cpanel.cities')}}</span>
                            <!--end::Label-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Items-->
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
                                                                    ...
                                                                    {!! \App\Http\Core\Adapters\Theme::getSvgIcon('icons/duotune/maps/map001.svg',' svg-icon-2 svg-icon-primary') !!}
                                                                    <!--end::Svg Icon-->
																</span>
                                    </div>
                                    <!--end::Symbol-->
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="fs-7 text-muted fw-semibold">{{$city->province->name ?? ''}}</span>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                <!--end::Item-->
