 ...
 */
class Theme extends \App\Http\Core\Theme\Theme
{
    ...
    public static function printHtmlClasses($scope, $full = true)
    {
        ...
        \App\Http\Core\Theme\Theme::printHtmlClasses($scope, $full);
    ...
    public static function printHtmlAttributes($scope)
    {
        ...
        // Call the function from core Theme
        parent::printHtmlAttributes($scope);
    ...
    public static function printCssVariables($scope)
    {
        ...
        // Call the function from core Theme
        \App\Http\Core\Theme\Theme::printCssVariables($scope);
    ...
    {
        return config('bemoonim.general.product.version');
    }
    ...
    public static function getPagePath()
    {
        ...
        $segments = request()->segments();
        if (!empty($segments)) {
            \App\Http\Core\Theme\Theme::$page = implode('/', $segments);
        }

        return \App\Http\Core\Theme\Theme::getPagePath();
    }
