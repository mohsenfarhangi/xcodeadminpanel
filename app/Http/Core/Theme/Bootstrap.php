...
class Bootstrap
{
    ...
    protected static $horizontalMenu;
    ...
    protected static function initHeader()
    {
    ...
    protected static function initToolbar()
    {
        ...
        Theme::addCssVariable('body', 'height', '100% !important');
    }

    protected static function initPageTitle()
    {
    ...
    protected static function initAside()
    {
    ...
    protected static function initHorizontalMenu()
    {
    ...
    protected static function initFooter()
    {
